...
public interface ITimetable {
     ...
     *
     * @param term      The term checked for the transferability
     * @param full_time Full-time or part-time studies
     ...
     *
     * @param term The term of the lesson
